      ...
      <div className="container">
        ...
        <main className="main">
          <section className="section section__skills">
            <div className="section__quehacemos">
              <h2 className="section__title--skills">Que hacemos</h2>
              <div className="section__container">
                <Icon icon={websiteIcon} color="#ffffff" className="iconos" />
                <span className="subtitulos section__title--subtitle">
                  Paginas Web
                </span>
              </div>
              <div className="section__container">
                <Icon icon={trolley2} color="#ffffff" className="iconos" />
                <span className="subtitulos section__title--subtitle">
                  Tiendas E-commerce
                </span>
              </div>
            ...
            <div className="section__queusamos">
              <h2 className="section__title--skills" id="que-usamos">
                Que usamos
              </h2>
              ...
              <div className="container__grid--icons">
                <Icon
                  icon={fileTypeHtml}
                  className="container__grid--technologies"
                />
                <Icon
                  icon={fileTypeCss}
                  className="container__grid--technologies"
